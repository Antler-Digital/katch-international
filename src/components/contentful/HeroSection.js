...
function HeroSection({
  ...
  const getTextStyle = (text) => {
    ...
    if (textLength > 40) return "-bottom-[53px] md:-bottom-[63px] lg:-bottom-[140px]  relative text-4xl md:text-5xl lg:text-[80px]"
    if (textLength > 30) return "-bottom-[42px] md:-bottom-[63px] lg:-bottom-[176px]  relative text-5xl md:text-7xl lg:text-[110px]"
...
return (
  <>
    <section
      className={` h-[500px] ${backgroundImage || carouselImages
        ? "h-[500px]"
    ...
    >
      ...
      >
        {/* <div className={` w-full md:h-full text-left relative bottom-0 `}> */}
          {header && (
            <h1
              className={`${getTextStyle(header?.trim())} font-bold block self-end ${colorText}`}
            >
