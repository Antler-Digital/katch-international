...
const ChangeCaseStudy = ({ prevCaseStudy, nextCaseStudy }) => {
  return (
    <div className="w-full max-h-32 h-16 flex overflow-hidden">
      <div className="relative w-3/5">
        <Linked linkTo={`/project/${nextCaseStudy.slug}`}>
          <button
            type="button"
            className="absolute z-10 left-0 uppercase text-xl text-white bg-secondary mix-blend-hard-light py-3 px-5 h-full"
          >
            Previous Project
          </button>
        </Linked>
      ...
      <div className="relative w-2/5">
        ...
        <Linked linkTo={`/project/${nextCaseStudy.slug}`}>
          <button
            type="button"
            className="absolute z-10 right-0 uppercase text-xl text-white bg-secondary mix-blend-hard-light py-3 px-5 h-full"
          >
            Next Project
          </button>
        </Linked>
